...
public class CompileTimeWeaverApplication {

    private static final Logger log = org.slf4j.LoggerFactory.getLogger(CompileTimeWeaverApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(CompileTimeWeaverApplication.class, args);
    }
